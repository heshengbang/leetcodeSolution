...
public class NIO2Client implements Runnable{
    ...
    public NIO2Client(AsynchronousChannelGroup channelGroup, CountDownLatch latch) throws IOException, InterruptedException{
        this.latch = latch;
        helper = new Helper();
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for(int i=0; i<THREAD_NUM; i++){
            NIO2Client c = new NIO2Client(channelGroup, latch);
